...
## [1.4.0](https://github.com/webmappsrl/forestas/compare/v1.3.0...v1.4.0) (2026-09-24)
...
* **database:** ✨ add sardegnasentieri configuration and initialization script ([f0af59d](https://github.com/webmappsrl/forestas/commit/f0af59d0a55f60d0d4ad95eeb7720cc3c443f80b))
...
* **oc:8168:** align forestas to wm-package a94a634f ([85163fa](https://github.com/webmappsrl/forestas/commit/85163fa948de1bbd65010afaaa605c3c30c71eb1))
* **oc:8333:** aggiunge l'azione Nova per creare il client SUS ([7aeded4](https://github.com/webmappsrl/forestas/commit/7aeded4b6512214648a97644e8cde06acfe7a4b0))
* **oc:8333:** branch API SUS con autenticazione dedicata ([#9](https://github.com/webmappsrl/forestas/issues/9)) ([d61701c](https://github.com/webmappsrl/forestas/commit/d61701cdd14a059528c7fecef0fe1ad4e1d3446f))
* **oc:8489:** adotta il dominio trail_registry e allinea il catasto a Drupal ([#8489](https://github.com/webmappsrl/forestas/issues/8489)) ([4a6f467](https://github.com/webmappsrl/forestas/commit/4a6f467c0484b17c62267ca3bca36dfe8e97c950))
* **oc:8489:** la documentazione API SUS passa da «Strumenti» a «Catasto» ([1ae807a](https://github.com/webmappsrl/forestas/commit/1ae807a2ffe55566717f5b9dca414d1ac12f75e5))
* **oc:8492:** gate stub wm-package in CI e adesione al dominio trail_registry ([#10](https://github.com/webmappsrl/forestas/issues/10)) ([cb84c27](https://github.com/webmappsrl/forestas/commit/cb84c273e878be5d306bbc7f6395d78fcae60ca2))
...
* **sync:** 🔄 extend taxonomy sync to additional locales OC:7611 ([#6](https://github.com/webmappsrl/forestas/issues/6)) ([9dbdc35](https://github.com/webmappsrl/forestas/commit/9dbdc3502cbcafb4edc50eac8f2e6d3fd3c46081))
...
* **import-gpx-route:** importa i track il cui GPX usa &lt;rte&gt; invece di &lt;trk&gt; ([6a723ef](https://github.com/webmappsrl/forestas/commit/6a723ef427b5366b4ec42801d2879e9fe71ed456))
...
* **oc:8237:** correggi traduzioni e icone mancanti nell'import tassonomie Sardegna Sentieri ([1c711e9](https://github.com/webmappsrl/forestas/commit/1c711e9c817988e4c030ef3a7db656968fa26506))
* **oc:8333:** .env.testing non piu' versionato, chiavi generate al setup ([ff7c598](https://github.com/webmappsrl/forestas/commit/ff7c5985215eada90e2f733f8f5a44089d196f94))
* **oc:8469:** bump wm-package con il fix identifier TaxonomyWhere ([#8](https://github.com/webmappsrl/forestas/issues/8)) ([c9e4b09](https://github.com/webmappsrl/forestas/commit/c9e4b096ed0625e7acc90fed619cd49aa9873c8b))
* **oc:8489:** due guardie davanti al troncamento dell'import ([8d65492](https://github.com/webmappsrl/forestas/commit/8d654925ec4beca6e44b78cdb61cee6306bb59c4))
* **oc:8492:** aggiunge la migration create_users_table mancante ([42f0c3d](https://github.com/webmappsrl/forestas/commit/42f0c3d010482d150636f3e55ba2ac7ce8d52628))
* **oc:8607:** il reset ricalcola le anomalie a job finiti ([a42a62f](https://github.com/webmappsrl/forestas/commit/a42a62f30d6dfd5faa0424a5d33e64b53a5953a5))
* **oc:8607:** l'import ha una coda sua e le tassonomie reggono la concorrenza ([1acebb2](https://github.com/webmappsrl/forestas/commit/1acebb21785c62d377c50854aff76d3ec0bb4b83))
...
* **phpstan-clean:** azzera i 140 errori PHPStan e corregge tre bug emersi ([cf0efa6](https://github.com/webmappsrl/forestas/commit/cf0efa6e7e1d897f36ebfb7ef7629a88c8c800ec))
...
* allinea forestas a wm-package develop (autoload TranslationsBuilder + migration pubblicate) ([76092a5](https://github.com/webmappsrl/forestas/commit/76092a5b996585ea856a1c3cf2e92d1de48b39b4))
* allinea wm-package al fix ricarica geometry OSM2CAI ([13a9f03](https://github.com/webmappsrl/forestas/commit/13a9f03b9a5400785723d633c908f8d2969ef8e5))
...
* **oc:8489:** allinea wm-package all'ordinamento del registro dei codici ([a609d87](https://github.com/webmappsrl/forestas/commit/a609d871ff0886b0beb0b2e679111354d749ecba))
* **oc:8489:** allinea wm-package alla creazione d'ufficio dell'istanza ([f2adab2](https://github.com/webmappsrl/forestas/commit/f2adab2efeca31bd952de85e969d626486953210))
* **oc:8528:** allinea il puntatore di wm-package al riordino del CLAUDE.md ([90b72ee](https://github.com/webmappsrl/forestas/commit/90b72eea1da7643e7fe2c3f9fe6fb1b8323852bb))
* **oc:8569:** allinea wm-package alla sostituzione del numero dall'istanza ([f8a53f9](https://github.com/webmappsrl/forestas/commit/f8a53f9e0df4945b6b1df1cce40731b2f55bfc3a))
* **oc:8570:** allinea wm-package al criterio di vicinanza per il numero proposto ([a070b3e](https://github.com/webmappsrl/forestas/commit/a070b3e49ecf87fd415f64b899d1242be05e91cb))
